...
\subsection{Funciones del Producto}
	\begin{itemize}
		...
		%\item DEBERÁ contabilizar los small-RNA$_s$ que se hibridan a la secuencia random.
...
\subsection{Funciones del Sistema}
	...
	\begin{itemize}
		...
		\item \textbf{Nombre del requerimiento:} Calcular el score de matching sobre la secuencia original (RF9).\\
 	    \textbf{Propósito:} determinar cuanto matching existe entre el RNA original y el segmento resultante de la hibridación por cada posición del RNA$_m$.\\
		\textbf{Input:} secuencia de RNA original hibrizada. \\
		\textbf{Procesamiento:} Cada hibridación, sea A=T o G=C tendrá un valor representado a través de una constante. Se recorrerá la secuencia tomada 									como entrada y se contará la cantidad de hibridación del tipo A=T por un lado, y por otro lado G=C. Luego se realizará el 									siguiente cálculo: 
									\begin{center}
										\textbf{$\displaystyle \frac{(\#AT * constAT + \#GC * constGC)}{(totalAT constAT + totalGC * 													constGC$}}											
  									\end{center}
								\par donde:
								\begin{itemize}
